...
var csvArray = [["Teacher", "Date", "Team", "Level", "Time", "Action", "Actor", "Message", "Input", "Result",
    "Old Resistance", "New Resistance", "Dial Position", "Probe Positions", "Measurement type",
    "Measurement Result", "Total Mssg Score", "Number Mssgs", "Avg Mssg Score"]]; //Array of values to be downloaded as a .csv file
